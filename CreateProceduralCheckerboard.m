function [id, rect, shader] = CreateProceduralCheckerboard(windowPtr, width, height, ...
	color1, color2, radius)
% [id, rect, shader] = CreateProceduralCheckerboards(windowPtr, width,
% height [, color1=[1 1 1]]  [, color2=[0 0 0]] [, radius=inf])
%
